...
const (
	...
	DefaultNodeLogDir     = "/var/log/quilibrium"
...
// GetNodeLogDir returns the configured node log directory or the default
// /var/log/quilibrium.
func GetNodeLogDir() string {
	cfg := loadConfigOrDefault()
	if cfg.NodeLogDir != "" {
		return cfg.NodeLogDir
	}
	return DefaultNodeLogDir
}
