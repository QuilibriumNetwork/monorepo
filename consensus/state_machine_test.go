...
// func (t TestPeerID) GetRank() uint64 {
// 	return 0
// }
...
// func (m *mockVotingProvider) SendProposal(ctx context.Context, proposal *TestState) error {
// 	m.mu.Lock()
// 	defer m.mu.Unlock()
...
// func (m *mockVotingProvider) SendVote(ctx context.Context, vote *TestVote) (TestPeerID, error) {
// 	return "", nil
// }

// func (m *mockVotingProvider) IsQuorum(ctx context.Context, proposalVotes map[Identity]*TestVote) (bool, error) {
// 	totalVotes := 0
...
// func (m *mockVotingProvider) SendConfirmation(ctx context.Context, finalized *TestState) error {
// 	m.mu.Lock()
// 	defer m.mu.Unlock()
...
// func (m *mockLeaderProvider) GetNextLeaders(ctx context.Context, prior *TestState) ([]TestPeerID, error) {
// 	if len(m.leaders) > 0 {
...
// func (m *mockLivenessProvider) SendLiveness(ctx context.Context, prior *TestState, collected TestCollected) error {
// 	m.mu.Lock()
// 	defer m.mu.Unlock()
// 	m.sentLiveness++
// 	return nil
...
// 	err := sm.ReceiveProposal(1, "external-leader", &TestState{
// 		Round:      1,
// 		Hash:       "external-hash",
// 		Timestamp:  time.Now(),
...
// 	sm.ReceiveProposal(1, "leader2", &TestState{
// 		Round:      1,
// 		Hash:       "test-hash",
// 		Timestamp:  time.Now(),
...
// func (m *mockPanickingVotingProvider) SendProposal(ctx context.Context, proposal *TestState) error {
// 	m.mu.Lock()
// 	defer m.mu.Unlock()
// 	m.sentProposals = append(m.sentProposals, proposal)
// 	return nil
...
// func (m *mockPanickingVotingProvider) IsQuorum(ctx context.Context, proposalVotes map[Identity]*TestVote) (bool, error) {
// 	totalVotes := 0
// 	voteCount := map[string]int{}
// 	for _, votes := range proposalVotes {
// 		count, ok := voteCount[votes.ProposalID]
...
// func (m *mockPanickingVotingProvider) SendVote(ctx context.Context, vote *TestVote) (TestPeerID, error) {
// 	return "", nil
// }

// func (m *mockPanickingVotingProvider) SendConfirmation(ctx context.Context, finalized *TestState) error {
// 	panic("PANIC HERE")
// }
